...
import Comment from 'src/app/blog/components/comment/comment'
import person from '/src/app/blog/images/profileIcon.png'
        ...
        <div className={classes.container}>
            <div className={classes.wrapper}>
                <div className={classes.blogImageWrapper} > 
                    <Image src={blogDetails?.imageUrl} width='750' height='550' />
                </div>
                            ...
                            blogDetails?.authorID?._id.toString() === session?.user?._id.toString()
                                ? (
                                    <div className={classes.controls}>
                                        <Link className={classes.editButton} href={`/blog/blogPost/edit/${ctx.params.id}`}>
